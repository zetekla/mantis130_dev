...
if ( $t_show_description ) {
	...
	// ERP funcs moved to bug_desc_display.php
	$t_list_attachments = bug_inline_get_attachments($f_bug_id);
	if (ERP_bug_from_email( $f_bug_id))
		$t_description = show_description($f_bug_id, $t_list_attachments)->description;
	echo $t_description;
	echo '</td>';
	echo '</tr>';
}
